        ...
        <div className="w-full px-6 md:px-12 flex items-center justify-between relative">
          ...
          <div
            className={`p-1 rounded-full transition-all duration-300 ${
              isScrolled
                ? "ring-2 ring-[#1C5DFD]/15 shadow-[0_0_16px_4px_rgba(28,93,253,0.45)]"
                : "ring-2 ring-[#FFFFFF] shadow-[0_2px_10px_rgba(0,0,0,0.08)]"
              }`}
            >
            <Image src="/logo-icon.png" alt="FinWise logo" width={48} height={48} className="w-12 h-12 object-contain rounded-full" priority />
          </div>
