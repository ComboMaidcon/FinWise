...
const steps = [
  ...
  },
  {
    ...
    description: "FinWise's AI analyzes your complete financial picture, building a personalized cash-flow model and identifying patterns specific to your situation.",
    iconBg: "bg-violet-50",
