...
- Privacy-first Input: cho phép nhập thủ công, định hướng hỗ trợ tải lên bản PDF của sao kê tài chính mà không yêu cầu kết nối tài khoản ngân hàng.
...
- Goal roadmap(Mỗi tháng cần dành bao nhiêu tiền để đạt mục tiêu tài chính?).
- Báo cáo hàng tháng.
...
- Dự báo 12 tháng.
- Scenario planning.
- Multi-income modeling(Phân tích theo nhiều nguồn thu).
...
Thay vì chỉ phục vụ người dùng cuối qua website hoặc ứng dụng riêng, FinSight sẽ phát triển một bộ public API để doanh nghiệp có thể tích hợp trực tiếp năng lực phân tích tài chính cá nhân vào sản phẩm của họ.

**Khách hàng B2B mục tiêu**

- Ngân hàng số và ví điện tử.
- Công ty bảo hiểm.
- Nền tảng payroll.
- Công ty HR benefits.
- Trường đại học hoặc tổ chức giáo dục.
- Doanh nghiệp lớn muốn cung cấp phúc lợi tài chính cho nhân viên.
- Các fintech muốn có scoring engine và recommendation engine mà không phải tự xây dựng từ đầu.

**Public API sẽ cung cấp**
...
Với public API, đối tác có thể gửi dữ liệu tài chính đã được người dùng đồng ý chia sẻ, sau đó nhận lại kết quả phân tích để hiển thị trực tiếp trong dashboard, mobile app hoặc hệ thống nội bộ của họ.

**Hạ tầng hỗ trợ doanh nghiệp**
...
- API key management.
- OAuth/SSO.
- Webhook cho cảnh báo rủi ro.
- SDK cho các framework phổ biến.
- Rate limiting.
- Audit log.
- Tenant-based access control.
- Dashboard quản trị.
- Báo cáo usage.
- Các gói SLA theo nhu cầu bảo mật, hiệu năng và tuân thủ dữ liệu.

**Mô hình doanh thu B2B**

- Phí nền tảng hàng tháng.
- Phí theo số lượng active users.
- Phí theo số lượng API calls.
- Gói enterprise tùy chỉnh cho các đối tác lớn.

Chiến lược này giúp FinSight không chỉ là một ứng dụng tài chính cá nhân, mà trở thành lớp hạ tầng financial intelligence có thể được nhúng vào nhiều hệ sinh thái khác nhau. Cách mở rộng này giúp sản phẩm tăng quy mô nhanh hơn, giảm phụ thuộc vào chi phí acquisition B2C và tạo nguồn doanh thu ổn định hơn từ khách hàng doanh nghiệp.
