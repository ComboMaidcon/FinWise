    ...
    <div key="analysis-results" className="min-h-screen bg-gradient-hero pt-24 pb-20 px-6 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-[#5C6B7A]">Here's a preview of what FinWise can do for you.</p>
        </motion.div>
            ...
            {cashFlow < 0 ? (
              <div className="p-4 rounded-xl bg-red-50 border border-red-200 flex gap-3">
                ...
                <div className="text-sm">
                  ...
                  <span className="text-red-500">You are spending more than you earn. FinWise can help you identify exactly where to cut back.</span>
                </div>
              </div>
            ) : (
              <div className="p-4 rounded-xl bg-[#1C5DFD]/[0.06] border border-[#1C5DFD]/15 flex gap-3">
                ...
                <div className="text-sm">
                  ...
                  <span className="text-[#5C6B7A]">You have a healthy surplus. Let FinWise optimize how to deploy this for your goals.</span>
                </div>
              </div>
            )}
          </motion.div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }} className="text-center">
          <Link href="/#pricing" className="btn-primary text-base px-10 py-4 inline-flex items-center gap-2 mb-4">
            <span>Get Your Full FinWise Plan</span>
