...
const benefits = [
  { icon: Eye, title: "Predicts risk instead of just reporting the past", description: "Most budgeting apps show you what already happened. FinWise's AI looks forward — modeling your next 6 months of cash flow based on your actual spending patterns to warn you before a shortfall hits.", highlight: "Proactive, not reactive.", visual: "forecast", flipped: false, accentHex: "#1C5DFD", textClass: "text-[#1C5DFD]", bgClass: "bg-[#1C5DFD]/[0.07]", borderClass: "border-[#1C5DFD]/15" },
  { icon: Zap, title: "Turns predictions into personalized recommendations", description: "Identifying a risk is only half the job. FinWise converts every risk and opportunity into a specific, actionable step you can take this week — not generic advice like 'spend less money'.", highlight: "Specific actions, real results.", visual: "recs", flipped: true, accentHex: "#10B981", textClass: "text-emerald-600", bgClass: "bg-emerald-50", borderClass: "border-emerald-200" },
  { icon: FileUp, title: "No bank integration — manual or PDF upload", description: "You're always in control. Enter data manually or upload a PDF statement. FinWise never requests access to your bank credentials, and there's no third-party OAuth required.", highlight: "Zero sensitive credentials needed.", visual: "upload", flipped: false, accentHex: "#7C3AED", textClass: "text-violet-600", bgClass: "bg-violet-50", borderClass: "border-violet-200" },
  { icon: BrainCog, title: "An ongoing AI coach, not a one-time report", description: "FinWise grows with you. As your income, expenses, or goals change, your Health Score, forecast, and action plan update automatically — keeping your financial strategy always current.", highlight: "Always up-to-date.", visual: "coach", flipped: true, accentHex: "#F59E0B", textClass: "text-amber-600", bgClass: "bg-amber-50", borderClass: "border-amber-200" },
];
