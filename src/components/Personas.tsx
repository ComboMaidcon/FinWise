...
const personas = [
  {
    ...
    howFinWise: "FinWise maps exactly where your money goes, shows when a shortfall is coming weeks in advance, and gives you a specific weekly budget that actually works for your income.",
  ...
  },
  {
    ...
    howFinWise: "FinWise's cash-flow model adapts to irregular income, forecasting slow months in advance and helping you build the right financial buffer to stay stable.",
  ...
  },
  {
    ...
    howFinWise: "FinWise builds a personalized savings roadmap, tells you exactly how much to set aside each month, and adjusts your plan if life changes.",
    ...
    <section className="section-padding relative overflow-hidden bg-gradient-section">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        <AnimatedSection className="text-center mb-16">
          <div className="badge-brand mb-6 mx-auto w-fit">Who FinWise Is For</div>
          ...
          <p className="text-lg text-[#5C6B7A] max-w-2xl mx-auto">
            FinWise meets you where you are — whether you're struggling paycheck to paycheck,
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {personas.map((persona, i) => (
            ...
            >
              ...
              <div className="mb-6">
                <div className={`text-xs font-bold ${persona.labelColor} uppercase tracking-wider mb-2`}>How FinWise Helps</div>
                <p className="text-sm text-[#5C6B7A] leading-relaxed">{persona.howFinWise}</p>
              </div>
