...
export function WhyFinWise() {
  return (
    <section id="features" className="section-padding bg-gradient-section">
      <div className="max-w-7xl mx-auto">
        <AnimatedSection className="text-center mb-20">
          <div className="badge-brand mb-6 mx-auto w-fit">Why FinWise</div>
          ...
          <p className="text-lg text-[#5C6B7A] max-w-2xl mx-auto leading-relaxed">
            FinWise combines AI-powered analysis with behavioral science to give
